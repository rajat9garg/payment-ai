...
val migrateBrahmaTables by tasks.register("migrateBrahmaTables", FlywayMigrateTask::class) {
...
val cleanBrahmaFlyway by tasks.register("cleanBrahmaFlyway", FlywayCleanTask::class) {
    url = "jdbc:postgresql://localhost:5432/payment"
    user = "postgres"
    password = "postgres"
    locations = arrayOf("filesystem:${project.projectDir}/src/main/resources/db/migration")
        ...
        create("main") {
            jooqConfiguration.apply {
                ...
                generator.apply {
                    ...
                    target.apply {
                        packageName = "com.payment.infrastructure.jooq"
